...
const pricingInfo = {
    ...
    "Ref Sheet / Custom": {
        description: `
            <p>Price changes depending on the complexity.</p>
            <p>Designs are made based on concepts, clear ideas or aesthetics requested by the client.</p>
            <p>No shading included, I do not shade references.</p>
            <p>Color palette, flags, simple text, clothing on a singular piece etc. can be added without any additional cost.</p>
            <p>Back/side views and clothing refs cost extra, the cost is also dependent on the complexity. Overall price is decreased by 25% if the client wants their ref sheet made with symmetry tool</p>
            <p>Contact me for more details or if you have any questions.</p>
        `,
        base: "€60+",
        shading: "N/A",
        additional: "Varies"
